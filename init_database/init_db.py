from database.db import (
    get_session,  # ✅ используем get_session из db, не create_session
)
from models.category_new import CategoryNew
from models.Enums import Gender, RoleName
from models.new_dan import DanNew
from models.role_new import RoleNew
from utils.constants import JUDO_RANKS
from utils.password import hash_password, is_supported_password_hash
...
def init_admin():
    ...
    try:
        ...
        if admin:
            ...
            if not is_supported_password_hash(admin.password_hash):
                admin.password_hash = hash_password("admin123")
                session.commit()
                print("✅ Пароль админа обновлен: login=admin, password=admin123")
        else:
...
def init_category():
    ...
    try:
        categories = [
            # -------- MALE --------
            CategoryNew(
                name="-23 kg, ПОЛ: мужчины, ГОД: c 2014 по 2015",
                gender=Gender.male,
                min_weight=0,
                max_weight=23,
                min_year=2014,
            ...
            CategoryNew(
                name="-26 kg, ПОЛ: мужчины, ГОД: c 2014 по 2015",
                gender=Gender.male,
                min_weight=23,
                max_weight=26,
                min_year=2014,
            ...
            CategoryNew(
                name="-30 kg, ПОЛ: мужчины, ГОД: c 2014 по 2015",
                gender=Gender.male,
                min_weight=26,
                max_weight=30,
                min_year=2014,
            ...
            CategoryNew(
                name="-34 kg, ПОЛ: мужчины, ГОД: c 2014 по 2015",
                gender=Gender.male,
                min_weight=30,
                max_weight=34,
                min_year=2014,
            ...
            CategoryNew(
                name="-38 kg, ПОЛ: мужчины, ГОД: c 2014 по 2015",
                gender=Gender.male,
                min_weight=34,
                max_weight=38,
                min_year=2014,
            ...
            CategoryNew(
                name="-42 kg, ПОЛ: мужчины, ГОД: c 2014 по 2015",
                gender=Gender.male,
                min_weight=38,
                max_weight=42,
                min_year=2014,
            ...
            CategoryNew(
                name="-46 kg, ПОЛ: мужчины, ГОД: c 2014 по 2015",
                gender=Gender.male,
                min_weight=42,
                max_weight=46,
                min_year=2014,
            ...
            # -------- FEMALE --------
            CategoryNew(
                name="-22 kg, ПОЛ: женский, ГОД: c 2014 по 2015",
            ...
            CategoryNew(
                name="-25 kg, ПОЛ: женский, ГОД: c 2014 по 2015",
                gender=Gender.female,
                min_weight=22,
                max_weight=25,
                min_year=2014,
            ...
            CategoryNew(
                name="-28 kg, ПОЛ: женский, ГОД: c 2014 по 2015",
                gender=Gender.female,
                min_weight=25,
                max_weight=28,
                min_year=2014,
            ...
            CategoryNew(
                name="-32 kg, ПОЛ: женский, ГОД: c 2014 по 2015",
                gender=Gender.female,
                min_weight=28,
                max_weight=32,
                min_year=2014,
            ...
            CategoryNew(
                name="-36 kg, ПОЛ: женский, ГОД: c 2014 по 2015",
                gender=Gender.female,
                min_weight=32,
                max_weight=36,
                min_year=2014,
            ...
            CategoryNew(
                name="-40 kg, ПОЛ: женский, ГОД: c 2014 по 2015",
                gender=Gender.female,
                min_weight=36,
                max_weight=40,
                min_year=2014,
            ...
            CategoryNew(
                name="-44 kg, ПОЛ: женский, ГОД: c 2014 по 2015",
                gender=Gender.female,
                min_weight=40,
                max_weight=44,
                min_year=2014,
        ...
        existing_keys = {(c.name, c.gender, c.min_year, c.max_year) for c in existing}
